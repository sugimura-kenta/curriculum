...
FROM stock_table tbl1
INNER JOIN store_table tbl2 ON tbl1.store_code = tbl2.store_code 
INNER JOIN goods_table tbl3 ON tbl1.goods_code = tbl3.goods_code
...
VALUES ('M001','マフラー',4500,'2020-10-28')
