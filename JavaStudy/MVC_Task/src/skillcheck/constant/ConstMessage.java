...
public final class ConstMessage {
    ...
    /** ヌルポ */
    public static final String EXCEPTION_NULL1 = "1ヌルポです！&#010;NULLの可能性がある変数が存在します！&#010;メソッドを呼び出している変数の値を確認しましょう！";
    public static final String EXCEPTION_NULL2 = "2ヌルポです！&#010;NULLの可能性がある変数が存在します！&#010;メソッドを呼び出している変数の値を確認しましょう！";
    public static final String EXCEPTION_NULL3 = "3ヌルポです！&#010;NULLの可能性がある変数が存在します！&#010;メソッドを呼び出している変数の値を確認しましょう！";
    public static final String EXCEPTION_NULL4 = "4ヌルポです！&#010;NULLの可能性がある変数が存在します！&#010;メソッドを呼び出している変数の値を確認しましょう！";
    public static final String EXCEPTION_NULL5 = "5ヌルポです！&#010;NULLの可能性がある変数が存在します！&#010;メソッドを呼び出している変数の値を確認しましょう！";
