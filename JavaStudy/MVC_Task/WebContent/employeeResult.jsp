...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/employeeResult.css">
    ...
    <div class="div-table-list">
        ...
        <% for (EmployeeBean emp: empResultList) { %>
            <tr class="td-max-width td-last-btn td-last-checkbox">
                ...
                <td id="empId"><% out.print(emp.getEmpId()); %></td>
                <td title="<%=emp.getName()%>"><% out.print(emp.getName());%></td>
                <td title="<%=emp.getMail()%>"><% out.print(emp.getMail());%></td>
                <td title="<%=emp.getProgramingLanguage()%>"><% out.print(emp.getProgramingLanguage()); %></td>
                <td title="<%=emp.getComment()%>"><% out.print(emp.getComment()); %></td>
                <td>
